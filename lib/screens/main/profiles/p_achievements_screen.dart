                        ...
                        ListTile(
                          ...
                          trailing: FittedBox(
                            child: CircularPercentIndicator(
                              ...
                              animation: true,
                              percent:
                                  CertifiCount > 10 ? 1 : CertifiCount / 10,
                              center: Text(
                                CertifiCount > 10
                                    ? '100%'
                                    : '${(CertifiCount / 10) * 100}%',
                        ...
                        ListTile(
                          ...
                          trailing: FittedBox(
                            child: CircularPercentIndicator(
                              ...
                              animation: true,
                              percent:
                                  CertifiCount > 50 ? 1 : CertifiCount / 50,
                              center: Text(
                                CertifiCount > 50
                                    ? '100%'
                                    : '${(CertifiCount / 50) * 100}%',
                        ...
                        ListTile(
                          ...
                          trailing: FittedBox(
                            child: CircularPercentIndicator(
                              ...
                              animation: true,
                              percent:
                                  CertifiCount > 100 ? 1 : CertifiCount / 100,
                              center: Text(
                                CertifiCount > 100
                                    ? '100%'
