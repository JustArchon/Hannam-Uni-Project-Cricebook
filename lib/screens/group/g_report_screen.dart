...
class MemberReportScreen extends StatefulWidget {
  const MemberReportScreen({super.key, required this.userId, required this.groupId});
  final String userId;
          ...
          return SingleChildScrollView(
            child: Container(
                      ...
                      child: Column(
                        children:[
                          ...
                          Text("신고 대상: "+ snapshot.data!['userName'],
            ...
            onPressed: () {
              showDialog(
                ...
                builder: (context) {
                  return AlertDialog(
                          title: const Text("정말로 이 그룹원을 신고 하시겠습니까?"),
                          content: const Column(
                            mainAxisSize: MainAxisSize.min,
                            children: <Widget>[
                              Text('정확하게 신고 유형과 사유를 적었는지 확인바랍니다.'),
                              Text('신고 제출시 관리팀에서 확인후, 신고 사유가 확인된 후, 해당 회원에 대한 제제가 진행됩니다.'),
                            ...
                            TextButton(
                                ...
                                onPressed: () async {
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    const SnackBar(
                                      content: Text('정상적으로 신고가 완료되었습니다.'),
