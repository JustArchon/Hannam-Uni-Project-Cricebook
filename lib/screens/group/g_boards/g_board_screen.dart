...
class _GroupBoardScreenState extends State<GroupBoardScreen>
  ...
  Color mainColor1 = const Color(0xff6DC4DB);
  Color fontColor1 = Colors.white;
  Color mainColor2 = const Color(0xff6DC4DB);
  Color fontColor2 = Colors.black.withOpacity(0.7);
              ...
              child: Column(
                children: [
                  TabBar(
                    ...
                    unselectedLabelColor: fontColor2,
            ...
            return Wrap(
              ...
              children: documents.map(
                (doc) {
                  ...
                  int currentIndex = documents.indexOf(doc);
                  bool even = true;
                                    ...
                                    Container(
                                      decoration: BoxDecoration(
                                        ...
                                        gradient: LinearGradient(
                                          ...
                                          colors: even
                                              ? [
                                                  const Color(0xff002E41),
                                                  const Color(0xff6DC4DB),
                                                ]
                                              : [
                                                  const Color(0xffC0FAFF),
                                                  const Color(0xff6DC4DB),
                                                ],
                                        ),
                                        */
